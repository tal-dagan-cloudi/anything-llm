...
<p align="center">
  <a href="https://mind.law"><img src="https://github.com/tal-dagan-cloudi/mind.law-app/blob/master/images/wordmark.png?raw=true" alt="Mind.Law logo"></a>
</p>

<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="tal-dagan-cloudi%2Fmind.law-app | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>
...
<p align="center">
👉 Mind.Law for desktop (Mac, Windows, & Linux)! <a href="https://mind.law/download" target="_blank"> Download Now</a>
</p>

A full-stack application that enables you to turn any document, resource, or piece of content into context that any LLM can use as a reference during chatting. This application allows you to pick and choose which LLM or Vector Database you want to use as well as supporting multi-user management and permissions.

![Chatting](https://github.com/tal-dagan-cloudi/mind.law-app/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 🆕 [**Full MCP-compatibility**](https://docs.mind.law/mcp-compatibility/overview)
- 🆕 [**No-code AI Agent builder**](https://docs.mind.law/agent-flows/overview)
- 🖼️ **Multi-modal support (both closed and open-source LLMs!)**
- [**Custom AI Agents**](https://docs.mind.law/agent/custom/introduction)
- 👤 Multi-user instance support and permissioning _Docker version only_
- 🦾 Agents inside your workspace (browse the web, etc)
- 💬 [Custom Embeddable Chat widget for your website](https://github.com/tal-dagan-cloudi/mindlaw-embed/blob/main/README.md) _Docker version only_
...
- [Mind.Law Built-in](https://github.com/tal-dagan-cloudi/mind.law-app/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- `embed`: Submodule for generation & creation of the [web embed widget](https://github.com/tal-dagan-cloudi/mindlaw-embed).
- `browser-extension`: Submodule for the [chrome browser extension](https://github.com/tal-dagan-cloudi/mindlaw-extension).

## 🛳 Self-Hosting

Mind.Law & the community maintain a number of deployment methods, scripts, and templates that you can use to run Mind.Law locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
_These are apps that are not maintained by Mind.Law, but are compatible with Mind.Law. A listing here is not an endorsement._
...
Mind.Law by Mind.Law Inc contains a telemetry feature that collects anonymous usage information.
...
[View all telemetry events in source code](https://github.com/search?q=repo%3Atal-dagan-cloudi%2Fmind.law-app%20.sendTelemetry\(&type=code)
...
[![mindlaw contributors](https://contrib.rocks/image?repo=tal-dagan-cloudi/mind.law-app)](https://github.com/tal-dagan-cloudi/mind.law-app/graphs/contributors)

[![Star History Chart](https://api.star-history.com/svg?repos=tal-dagan-cloudi/mind.law-app&type=Timeline)](https://star-history.com/#tal-dagan-cloudi/mind.law-app&Date)
...
[profile-link]: https://github.com/tal-dagan-cloudi
[vector-admin]: https://github.com/tal-dagan-cloudi/vector-admin
[assistant-swarm]: https://github.com/tal-dagan-cloudi/openai-assistant-swarm
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/tal-dagan-cloudi/mind.law-app&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/tal-dagan-cloudi/mind.law-app&branch=render
