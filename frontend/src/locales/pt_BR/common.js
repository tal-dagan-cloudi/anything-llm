...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Mind.Law funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Mind.Law",
      description: "Ajude-nos a melhorar o Mind.Law. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Mind.Law?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Mind.Law?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o Mind.Law.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao Mind.Law, uma ferramenta de IA open-source da Mind.Law que transforma qualquer conteúdo em um chatbot treinado. Mind.Law é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "Mind.Law é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "Mind.Law pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. Mind.Law facilita seu uso.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Você está no caminho para se tornar um expert em Mind.Law!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do Mind.Law",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Mind.Law com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Mind.Law.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Mind.Law lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Mind.Law. Não são compartilhados com terceiros.",
    },
    pinning: {
