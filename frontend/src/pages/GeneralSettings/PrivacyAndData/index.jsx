      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            look on{" "}
            <a
              href="https://github.com/search?q=repo%3AMind.Law-Labs%2Fanything-llm%20.sendTelemetry(&type=code"
          ...
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            so that we can continue to improve Mind.Law for you.{" "}
            <a
              href="mailto:team@mind.law"
              className="underline text-blue-400"
              target="_blank"
            >
              team@mind.law
