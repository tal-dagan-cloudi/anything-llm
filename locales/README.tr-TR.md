...
<p align="center">
  <a href="https://mind.law"><img src="https://github.com/Mind.Law-Labs/anything-llm/blob/master/images/wordmark.png?raw=true" alt="Mind.Law logo"></a>
</p>

<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="Mind.Law-Labs%2Fanything-llm | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
<b>Mind.Law:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
  ...
  <a href="https://github.com/Mind.Law-Labs/anything-llm/blob/master/LICENSE" target="_blank">
      <img src="https://img.shields.io/static/v1?label=license&message=MIT&color=white" alt="License">
  </a> |
  <a href="https://docs.mind.law" target="_blank">
    Docs
  </a> |
   <a href="https://my.mind.law/aio-checkout?product=anythingllm" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">  
👉 Masaüstü için Mind.Law (Mac, Windows ve Linux)! <a href="https://mind.law/download" target="_blank"> Şimdi İndir</a>  
</p>  
...
![Mesajlaşma](https://github.com/Mind.Law-Labs/anything-llm/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Mind.Law-Labs/anythingllm-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_  
...
- [Mind.Law Built-in](https://github.com/Mind.Law-Labs/anything-llm/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Mind.Law-Labs/anythingllm-embed) oluşturma ve entegrasyonu için alt modül.  
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Mind.Law-Labs/anythingllm-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma  

Mind.Law ve topluluk, Mind.Law'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Mind.Law kurun →](../BARE_METAL.md)  
...
_Bu uygulamalar Mind.Law tarafından yönetilmemektedir, ancak Mind.Law ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._  
...
- [Coolify](https://coolify.io/docs/services/anythingllm/) - Tek tıklamayla Mind.Law dağıtımı yapmanıza olanak tanır.  
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - Mind.Law’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik  

Mind.Law Inc. tarafından geliştirilen Mind.Law, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.  

<details>  
<summary><kbd>Mind.Law için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>  

### Neden?  

Bu bilgileri, Mind.Law’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.  
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AMind.Law-Labs%2Fanything-llm%20.sendTelemetry\(&type=code)
...
[![anythingllm contributors](https://contrib.rocks/image?repo=mindlaw/anything-llm)](https://github.com/mindlaw/anything-llm/graphs/contributors)  

[![Star History Chart](https://api.star-history.com/svg?repos=mindlaw/anything-llm&type=Timeline)](https://star-history.com/#mindlaw/anything-llm&Date)  
...
Telif Hakkı © 2025 [Mind.Law][profile-link]. <br />  
Bu proje [MIT](../LICENSE) lisansı ile lisanslanmıştır.

<!-- LINK GROUP -->

[back-to-top]: https://img.shields.io/badge/-BACK_TO_TOP-222628?style=flat-square
[profile-link]: https://github.com/mindlaw
[vector-admin]: https://github.com/mindlaw/vector-admin
[assistant-swarm]: https://github.com/Mind.Law-Labs/openai-assistant-swarm
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mind.Law-Labs/anything-llm&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mind.Law-Labs/anything-llm&branch=render
