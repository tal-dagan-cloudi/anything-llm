...
/**
 * An interface to the Mind.Law Community Hub external API.
 */
const CommunityHub = {
  ...
  apiBase:
    process.env.NODE_ENV === "development"
      ...
      : "https://hub.external.mind.law/v1",
   ...
   * so we can unzip and import them to the Mind.Law instance.
  ...
  /**
   * Apply an item to the Mind.Law instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the Mind.Law instance by downloading the zip file and importing it.
